...
import { Info, Edit3, RefreshCw, Trash2, Home, ExternalLink } from 'lucide-react'
...
const ContextMenu = ({
  ...
  }, [activeMenu, accounts, onViewDetails, onEditNote, onReauth, onOpenBrowserHome, onOpenBrowserCustom, onRemove])
