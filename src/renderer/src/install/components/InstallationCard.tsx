  ...
  return (
    ...
    >
      ...
      <div className="px-4 pb-4 space-y-2">
        ...
        <button
          onClick={() => onSettings(install)}
          className="pressable w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-[var(--color-surface-strong)] border border-[var(--color-border)] text-[var(--color-text-primary)] text-sm font-medium transition-all hover:bg-[var(--color-surface-hover)] hover:border-[var(--color-border-strong)] hover:shadow-[var(--shadow-lg)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-surface)]"
        >
          <Settings size={14} />
          Settings
        </button>
